...
public interface ReservationRepository extends CrudRepository<Reservation, Long> {
    ...
    Reservation findFirstByDateTimeIsAfterAndDeniedIsFalseAndRejectedIsFalseOrderByDateTime(LocalDateTime dateTime);
    List<Reservation> findAllByDateTimeIsAfterAndDeniedIsFalseAndRejectedIsFalseOrderByDateTime(LocalDateTime dateTime);
